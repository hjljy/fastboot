...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setModuleName(scanner("请输入整体业务包名："));
...
//         如果模板引擎是 velocity
        ...
        */
        ...
        //设置字段前缀
        strategy.setFieldPrefix("Fb");

        // strategy.setSuperEntityClass("你自己的父类Entity,没有就不用设置!");
        // 写于父类中的公共字段
        // strategy.setSuperEntityColumns("id");
        // 公共父类
        // strategy.setSuperControllerClass("你自己的父类Controller,没有就不用设置!");
